...
namespace SysHotelv1.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        SysHotelEntities db = new SysHotelEntities();
        ...
        public ActionResult Index()
        {
            ...
            var query = (from user in db.AspNetUsers
                         ...
                         }).ToList().Select(a => new UserRoleViewModel { Id = a.Id, UserName = a.UserName, RoleName = a.RoleName}).ToList();
            return View(query);
           

        }
        [Authorize(Roles = "Administrator,RRHH")]
        public ActionResult Roles(string id)
        {
            AspNetUser user = db.AspNetUsers.Find(id);
            UserRoleViewModel userRole = new Models.UserRoleViewModel { UserName = user.UserName, Id = user.Id, AspNetRoles = user.AspNetRoles };
